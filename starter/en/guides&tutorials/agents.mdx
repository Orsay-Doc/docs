---
title: "📸 Agents"
description: "Set up your IA agent on Orsay"
---
...
2. **Fill in the agent details**:
   ...
   - **Your business offer**: Describe what you’d like the AI to pitch or highlight (e.g., product, service, special promotion) and share everithing you want the AI to know about your offer
   - **Qualification questions**: List questions your agent should ask to the leads for the qualification (e.g., current situation, budget, interest). Click on + if you want to add multiple questions.
...
5. **Click “Publish agent”**: The agent’s configuration will update accordingly.
   ...
   **While editing, you can also Preview the agent to verify the conversation flow(Conversation
   test).**
