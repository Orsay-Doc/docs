...
<Note>
  **Two ways to connect WhatsApp:** You can either connect your own existing WhatsApp Business account, or set up an external number — which will need to be connected to your Business Manager on Facebook.
</Note>
...
<AccordionGroup>
  <Accordion title="Step 1: Set up your WhatsApp account">
    <AccordionGroup>
      ...
      <Accordion title="📲 Connect your own Whatsapp">
      <Warning>
      You can use this method only if you use Whatsapp Business for your Whatsapp (not a personal account)
      </Warning>
        - **Go to Integration → WhatsApp**
