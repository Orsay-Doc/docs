...
- **Direct Messaging Automation**: Send personalised WhatsApp to reach out to new contacts.
- **AI Qualifications**: Our AI will converse with every contacts to make sure they are qualified and if so, the AI will make them book a call.
- **Upload CSV of contacts and contact them all**

### **🔹 Lead Management & CRM Sync**

- **Automatic Qualification**: Screen leads, ask the right questions, and book qualified calls.
- **CRM Integrations**: Native connection with **Zapier and other CRM.**
...
- **Timezone-Aware Scheduling**: Automatically adjust outreach and bookings to each prospect’s timezone.

### **🔹 Analytics & Control**

- **Advanced Analytics**: Track conversion, engagement, and ROI in real time.
...
<AccordionGroup>
  <Accordion title="Step 1: Set up your WhatsApp account">
    <AccordionGroup>
      ...
      <Accordion title="✅ Validate the phone number">
        - **Go to https://business.facebook.com/billing_hub → Select the right business you have just added a phone number to → go to Whatsapp and a payment method to it**
  ...
  <Accordion title="Create your template message">
    - **You can now create template message that you will use in the [Step 3: Create a Sequence section](#step-3-create-a-sequence)**
  ...
  <Accordion title="Step 3: Create a Sequence" id="step-3-create-a-sequence">
    ...
    <Accordion title="Different sequence Explanation">
      - **Message received** → The sequence will start each time a new lead send a message to your number
      - **Contact created** → Contact any new lead that has not been attributed to any other sequence
      - **Contact subscribed to sequence** → Start a sequence for the leads that have been assigned to this sequence
    ...
    - **Select the Agent, Response Delay and add followups if needed and then ‘Confirm’**
